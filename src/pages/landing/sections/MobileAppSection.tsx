...
export default function MobileAppSection() {
  return (
    <section className="relative py-5 sm:py-6 lg:py-7 overflow-hidden landing-section-perspective">
        ...
        <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl border border-white/15 bg-bg-primary/45 backdrop-blur-md p-4 sm:p-5 lg:p-5 shadow-2xl">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-[1.2fr_0.95fr] gap-4 lg:gap-5 items-center">
              <div className="order-2 lg:order-1">
                <ScrollReveal variant="elastic" delay={100}>
                ...
                <ScrollReveal variant="blur-up" delay={180}>
                  <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black mb-1.5 sm:mb-2 leading-tight bg-gradient-to-r from-primary via-cyan-600 to-emerald-600 bg-clip-text text-transparent landing-title-shine">
                    Take Checknown Everywhere You Go
                  </h2>
                </ScrollReveal>

                <ScrollReveal variant="pop-up" delay={260}>
                ...
                <ScrollReveal variant="flip-up" delay={340}>
                ...
                <ScrollReveal variant="elastic" delay={420}>
                ...
                <ScrollReveal variant="pop-up" delay={500}>
              ...
              <ScrollReveal variant="fade-left" delay={280}>
                <div className="relative mx-auto w-full max-w-[260px] sm:max-w-[280px] lg:max-w-[300px] order-1 lg:order-2 landing-hero-float">
