export default function ConnectedPeopleSection() {
  return (
    <section className="relative w-full py-12 sm:py-14 lg:py-16 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mb-7 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
          <div className="rounded-2xl border border-white/10 bg-bg-primary/40 backdrop-blur-sm p-4 shadow-lg">
